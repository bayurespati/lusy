...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers__ = __webpack_require__(290);
  ...
  mutations: {
    ...
    edit_gallery: function edit_gallery(state, updatedGallery) {
      if (updatedGallery.is_showcase) {
        ...
        state.galleryHide[galleryIndex].is_showcase = updatedGallery.is_showcase; //Push object to array gallery show

        state.galleryShow.push(state.galleryHide[galleryIndex]); //Delete the same object on gallery hide
        ...
        state.galleryShow[_galleryIndex].is_showcase = updatedGallery.is_showcase; //Push object to array gallery Hide

        state.galleryHide.push(state.galleryShow[_galleryIndex]); //Delete the same object on gallery Show
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Gallery_vue__ = __webpack_require__(280);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__showcasedImage_vue__ = __webpack_require__(284);
