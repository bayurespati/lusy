            ...
            <transition enterActiveClass="fade-in"
                ...
                <div class="row">
                    ...
                    <!--=========================================================================================
                        B U T T O N   E D I T
                        =========================================================================================-->
                    <div class="col-xs-12 col-md-2 align-items-center justify-content-around">
                        <button type="button" 
                    ...
                    <!--=========================================================================================
                        E D I T   J A B A P E L
                        =========================================================================================-->
                    <div class="col-md-12">
                        <edit-sosmed v-if="isEditingSosmed" :sosmed="sosmed"
                            @editionFormIsClosed="isEditingSosmed = $event">
                        </edit-sosmed>
                    </div>
                </div>
            </transition>
...
<script>
    import EditSosmed from './EditSosmed.vue';
    export default{
        props: {sosmed: {}},
